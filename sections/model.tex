...
Defining the fault model in terms of correlation coefficients of each pair of storage nodes is theoretically possible (as long as all coefficients are non-negative), and may be preferred over failure generators because the concept of correlation coefficient is widely adopted and determining the coefficients is easier than determining the failure generator of a system.
