...
The alternative definition of the fault model is in terms of the failure rate of individual storage nodes and the correlation coefficients of each pair of storage nodes (as long as all coefficients are non-negative). This alternation may be preferred over failure generators because the concept of correlation coefficient is widely adopted and determining the individual failure rates and the coefficients is easier than determining the failure generator of a system.
