...
\subsubsection{Primitives}
Suppose in our system of $\Omega$ data objects, each object is made up of $K+R$ chunks; where only a minimum of $K$ chunks is necessary to reconstuct the original data object. 
