...
We apply our simulator to evaluate existing decentralized storage systems~\cite{irisstore,glacier,cfs,carbonite,ipfs,xfs,oceanstore}.
\lijl{Summarize evaluation results and insights here.}

Based on the insights we learned from simulations, we propose a new decentralized storage design that provides strong durability guarantees.
\lijl{Summarize design here.}
