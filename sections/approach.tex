...
Instead, \sys performs node selection in a fully decentralized fashion, through a procedure termed Kleroterion~\footnote{Kleroterion was a randomization machine used in ancient Athens to select council members for citizens.}.
