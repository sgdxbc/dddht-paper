...
\sgd{Maybe go into related work, or omitted.} \textbf{Purely incentive-based approaches.} Filecoin and Arweave.
...
Uncoordinated symbol generation may lead to insufficient \textit{unique} symbols to recover the original data, an issue analogous to the coupon collector's problem \lijl{citation} \cite{ccp}.
...
The core of Kleroterion is the use of \textit{verifiable random functions} (VRF) \lijl{citation} \cite{vrf}.
