...
Under the assumption that less than $1/3$ of the participants are Byzantine at any time, by randomly selecting nodes to store the generated or the repaired encoding symbols, \sys only needs to pay an approximately $0.33$ redundancy penalty compared to the base fountain code.
